...
while mainloop:
    ...
    if opcion == 1:
        ...
        for i in range(identificador, len(tareas)):
            identificador = str(i + 1).zfill(2)
            if not estaElemento(identificador, tareas):
                break
    ...
    # Delete
        ...
        # Solicitar al usuario el identificador
        identificador = str(
            input("Ingrese identificador de la Tarea para eliminar: "))
